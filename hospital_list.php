...
<section class="content flex flex-col items-center pt-28 px-5 sm:px-20 -z-10 ">
    <form class="flex items-center w-full border-2 rounded-lg">
        <div class="relative w-full">
            ...
            <input class="h-10 w-full pl-10 pr-3 text-center outline-none rounded-lg" type="text" name="query" placeholder="Cari rumah sakit berdasarkan nama, alamat..." value="<?= $query ?>">
            <?php if ($query) : ?>
