                    ...
                    <form class="rating_card " method="post">
                        ...
                        <div class="flex items-center mt-3">
                            ...
                            <input type="radio" id="star<?= $i ?>" name="rate" value="<?= $i ?>"
                                <?= $i == $userRating ? 'checked' : '' ?> class="hidden" disabled />
                        ...
                        <textarea id="comment" name="comment" rows="4" cols="30"
                            class="w-full mt-4 border rounded-lg focus:outline-none focus:border-blue-500 px-3 py-2"
                            placeholder="Edit pesan" disabled><?= $userComment ?></textarea>

                        <button type="button" name="edit" value="edit"
                            class="mt-4 px-6 py-2 bg-black text-white font-bold rounded-lg focus:outline-none"
                            onclick="handleEdit()">Edit</button>

                        <button type="submit" name="submitEdit" value="submitEdit"
                            class="hidden mt-4 px-6 py-2 bg-black text-white font-bold rounded-lg focus:outline-none">Submit</button>

                        <button type="button" name="cancel" value="cancel"
                            class="hidden mt-4 px-6 py-2 bg-black text-white font-bold rounded-lg focus:outline-none"
                        ...
                        <textarea id="comment" name="comment" rows="4" cols="30"
                            class="w-full mt-4 border rounded-lg focus:outline-none focus:border-blue-500 px-3 py-2"
                            placeholder="Tambahkan pesan"></textarea>
